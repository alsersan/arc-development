...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    if (totalCost) {
      // if there is a cost, then it's an estimate
      if (category) {
        // if there's a category, then it's an estimate for a website
        mailOptions = {
          from: "Arc Development <patataisadev@gmail.com>",
          to: "patataisadev@gmail.com",
          subject: "Message from Arc Development",
          html: `
          ...
          <p style="font-size: 16px">Total Cost: $${totalCost}</p>
      `,
        };
      } else {
        // if there's no category, then it's an estimate for custom software / app development
        mailOptions = {
          from: "Arc Development <patataisadev@gmail.com>",
          to: "patataisadev@gmail.com",
          subject: "Message from Arc Development",
      ...
      // if there's no cost, then it is a contact form
    ...
    const messageOptions = totalCost
      ? {
